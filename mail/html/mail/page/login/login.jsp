...
<script type="text/javascript" src="/mail/js/login.js"></script>
...
<body onresize="Center()" onload="Center()" style="padding-top: 0px;">
	...
	<input type="hidden" id="domainhost" value="" />
				...
				<div class="right">
					<div class="login">
						<form action="" method="post" name="loginForm" id="loginForm">
							<h1>单位邮箱用户登录</h1>
							<ul>
								<li><label>帐 号：</label> <label><input type="text"
								...
								<li><span id="error">请填写单位邮箱用户帐号。</span></li>
								<li style="margin:15px 0px 15px;"><label>密 码：</label> 
									<label><input
