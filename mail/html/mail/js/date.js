...
Calendar.prototype.getStyle = function () {
	...
	str += ".calendar{position:absolute;width:160px!important;width /**/:144px;height:164px!important;height /**/:174px;background-color:" + this.style.bodyBackColor + ";border:1px solid " + this.style.borderColor + ";left:0px;top:0px;z-index:9999;}\n";
	...
	str += ".dayOver{height:16px;padding:0px;background-color:#909EFF;color:#FFFFFF;}\n";
	...
	str += "html>body #Calendar{width:160px;174px;}";
	str += "</style>\n";
	return str;
};
Calendar.prototype.getHeader = function () {
	var str = "<table Author=\"alin\" class=\"cdrHeader\" cellSpacing=\"2\" cellPadding=\"0\" style=\"line-height:16px;\"><tr Author=\"alin\" align=\"center\">\n";
	str += "<td Author=\"alin\" onmouseover=\"this.className='headerOver'\" onmouseout=\"this.className=''\" id=\"previousYear\" title=\"\u4e0a\u4e00\u5e74\u4efd\" style=\"cursor:pointer;width:13px;\" onclick=\"" + this.Obj + ".onChangeYear(false);\"><<</td>\n";
	str += "<td Author=\"alin\" onmouseover=\"this.className='headerOver'\" onmouseout=\"this.className=''\" id=\"previousMonth\" title=\"\u4e0a\u4e00\u6708\u4efd\" style=\"cursor:pointer;width:11px;\" onclick=\"" + this.Obj + ".onChangeMonth(false);\"><</td>\n";
	str += "<td Author=\"alin\" onmouseover=\"this.className='headerOver'\" id=\"currentYear\" style=\"cursor:pointer;width:50px;\" onclick=\"" + this.Obj + ".showMenu(true);\" onmouseout=\"" + this.Obj + ".hideMenu();this.className='';\">0</td>\n";
	str += "<td Author=\"alin\" onmouseover=\"this.className='headerOver'\" id=\"currentMonth\" style=\"cursor:pointer;width:38px;\" onclick=\"" + this.Obj + ".showMenu(false);\" onmouseout=\"" + this.Obj + ".hideMenu();this.className='';\">0</td>\n";
	str += "<td Author=\"alin\" onmouseover=\"this.className='headerOver'\" onmouseout=\"this.className=''\" id=\"nextMonth\" title=\"\u4e0b\u4e00\u6708\u4efd\" style=\"cursor:pointer;width:11px;\" onclick=\"" + this.Obj + ".onChangeMonth(true);\">></td>\n";
	str += "<td Author=\"alin\" onmouseover=\"this.className='headerOver'\" onmouseout=\"this.className=''\" id=\"nextYear\" title=\"\u4e0b\u4e00\u5e74\u4efd\" style=\"cursor:pointer;width:13px;\" onclick=\"" + this.Obj + ".onChangeYear(true);\">>></td></tr>\n";
	str += "</table>\n";
	return str;
};
Calendar.prototype.getBody = function () {
	...
	str += "<table Author=\"alin\" class=\"cdrBody\" cellSpacing=\"2\" cellPadding=\"0\" style=\"line-height:16px;\">\n";
	for (i = 0; i < 6; i++) {
...
Calendar.prototype.getYearMenu = function (year) {
	var str = "<table Author=\"alin\" cellSpacing=\"0\" class=\"cdrMenu\" cellPadding=\"0\" style=\"line-height:16px;\">\n";
	for (i = 0; i < 10; i++) {
		var _year = year + i;
...
Calendar.prototype.show = function () {
	...
	if ((document.body.clientHeight - (_target.y + _evObj.clientHeight)) >= _obj.clientHeight) {
		...
		_obj.style.top = (_target.y - _obj.clientHeight - 1) + "px";
	}
};
...
Date.prototype.toFormatString = function (fs) {
	...
	if (fs.length == 1) {
		return this.getFullYear() + fs + mon + fs + day;
	}
	fs = fs.replace("yyyy", this.getFullYear());
	fs = fs.replace("mm", mon);
	fs = fs.replace("dd", day);
	return fs;
};
var inputObj = null;
var targetObj = null;
