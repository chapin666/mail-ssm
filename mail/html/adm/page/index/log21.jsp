		...
		<div class="right">
			<div class="con_box">
				...
				<div class="searchtitle">
					...
					<span class="on">按帐号</span>
					<span onclick="location.href='/log/log!list22.mail';">管理员</span>
				</div>
				<div class="searchcontent" id="searchcontent1">
					<form action="/log/log!list21.mail" method="post" name="searchForm" id="pageForm">
					<input type="hidden" name="pagenow" id="pagenow" value="1">
					<p>
						<span>查询帐号：</span>
						<input type="text" name="username" id="username" value="${logger.username }" class="input" style="width:200px;" />
					</p>
					<p>
				...
				<div class="con_body">
					<c:if test="${searchValue eq 1}">	
						<div class="bodylist">
							<ul>
								<li class="title">
									<span class="listspan111">操作时间</span>
									<span class="listspan22">成员</span>
									<span class="listspan22">登录ip</span>
									<span class="listspan22">操作</span>
								</li>
