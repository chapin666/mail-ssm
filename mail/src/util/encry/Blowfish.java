...
public class Blowfish {
    ...
    public static String decrypt(String cipher){
        return bf.decryptString(cipher);
    }
    
    public static String encrypt(String plainText){
        return bf.encryptString(plainText);
    }
	...
	public static void main(String[] args) {
		...
		System.out.println(crypt.encryptString("cdzfgjj"));
		System.out.println(crypt.decryptString(crypt.encryptString("jfcjyo")));
	}
}
